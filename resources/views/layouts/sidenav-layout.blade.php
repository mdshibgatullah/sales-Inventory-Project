...
<div id="sideNavRef" class="side-nav-open">
    ...
    <a href="{{url('/sale')}}" class="side-bar-item {{ request()->routeIs('sale') ? 'side-bar-item-active' : '' }}">
        <i class="bi bi-currency-dollar"></i>
        <span class="side-bar-item-caption">Create Sale</span>
    </a>

    <a href="{{url('/invoice')}}" class="side-bar-item {{ request()->routeIs('invoice') ? 'side-bar-item-active' : '' }}">
        <i class="bi bi-receipt"></i>
        <span class="side-bar-item-caption">Invoice</span>
    </a>

    <a href="{{url('/report')}}" class="side-bar-item {{ request()->routeIs('report') ? 'side-bar-item-active' : '' }}">
