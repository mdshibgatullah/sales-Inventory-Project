...
<script>
    ...
    async function FillUpUpdateForm(id){
        ...
        showLoader();
        let res=await axios.post("/customer_id",{id:id})
        hideLoader();
    ...
    async function Update() {
        ...
        if (customerName.length === 0) {
            ...
            let res = await axios.post("/customer_update",{name:customerName,email:customerEmail,mobile:customerMobile,id:updateID})
